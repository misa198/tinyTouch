...
class ReleasePipelineTests(unittest.TestCase):
    ...
    def test_build_tag_and_release_workflow_contract(self):
        ...
        ci = (workflows / "firmware-ci.yml").read_text()
        ...
        self.assertIn("branches: [master]", ci)
        self.assertIn("pull_request:", ci)
        self.assertIn("firmware/**", ci)
        self.assertIn("packaging/assemble-release.py", ci)
        self.assertIn("packaging/release_integrity.py", ci)
        self.assertIn("tests/test_protocol6_firmware.py", ci)
        self.assertIn("uses: ./.github/workflows/firmware-build.yml", ci)
        self.assertIn("python3 -m unittest tests/test_protocol6_firmware.py", ci)
        ...
        self.assertIn("<version> <min-app-version> <max-app-version-exclusive>", tag_release)
    ...
    def test_app_build_tag_and_release_workflow_contract(self):
        ...
        ci = (workflows / "app-ci.yml").read_text()
        ...
        self.assertIn("workflow_dispatch:", build)
        self.assertIn("workflow_call:", build)
        self.assertNotIn("swift test", build)
        ...
        self.assertIn("branches: [master]", ci)
        self.assertIn("pull_request:", ci)
        self.assertIn("app/**", ci)
        self.assertIn("uses: ./.github/workflows/app-build.yml", ci)
        ...
        self.assertIn('LabeledContent("settings_version", value: version)', settings)
